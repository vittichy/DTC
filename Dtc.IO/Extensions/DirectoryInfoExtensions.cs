...
namespace Dtc.IO.Extensions
{
    public static class DirectoryInfoExtensions
    {
        ...
        public static List<FileInfo> GetFilesByExt(this DirectoryInfo directoryInfo, string extensionList, char extensionListSeparator = ';', SearchOption searchOption = SearchOption.TopDirectoryOnly)
        {
        ...
        public static List<FileInfo> GetFilesByExtRecursive(this DirectoryInfo directoryInfo, string extensionList, char extensionListSeparator = ';')
        {
